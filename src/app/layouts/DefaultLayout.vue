...
import { usePageTransition } from '@/app/model/usePageTransition'
...
.app-intro-overlay {
  ...
  background:
    ...
    radial-gradient(circle at 50% 110%, rgba(255, 255, 255, 0.05), transparent 34%),
    linear-gradient(165deg, #111111 0%, #151515 52%, #1a1a1a 100%);
}
...
.app-intro-card {
  ...
  background:
    ...
    linear-gradient(180deg, rgba(24, 24, 24, 0.92), rgba(17, 17, 17, 0.98));
...
.app-intro-meter span {
  ...
  background: linear-gradient(90deg, rgba(255, 255, 255, 0.7), var(--brand-primary-strong));
