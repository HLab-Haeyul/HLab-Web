  ...
  <AdminWorkspaceLayout>
    ...
    <template #hero>
      <section class="rounded-[1.6rem] border border-[#243654] bg-[#0a0f17d9] p-5 sm:p-7">
        ...
        <p class="mt-2 max-w-2xl text-sm text-zinc-400 sm:text-base">
          프로젝트 카드를 선택해서 트러블슈팅 글, 제목/요약/성과, 이미지, 협업 URL을 수정하거나
          추가합니다.
        </p>
    ...
    >
      ...
      <p class="mt-1 text-xs text-zinc-500">
        기본은 조회 화면이며, 버튼을 눌러 편집 모드로 전환합니다.
      </p>
      ...
      <div v-if="activeEditorPanel === null" class="mt-4 space-y-4">
        <article class="rounded-xl border border-[#2f2f2f] bg-[#111111] p-4">
          ...
          <div
            v-if="selectedProject.collaborationLinks.length > 0"
        ...
        >
          <div>
            ...
            <p class="mt-1 text-xs text-zinc-400">
              일반 설정 페이지처럼 항목별로 나눠서 수정할 수 있습니다.
            </p>
          </div>
          <button
            type="button"
            ...
            >
              ...
              <div class="mt-3 space-y-2">
                ...
                <p class="text-xs text-zinc-500">
                  로컬 이미지 파일을 선택하면 즉시 미리보기에 반영됩니다.
                </p>
              </div>
            </section>
          </div>
