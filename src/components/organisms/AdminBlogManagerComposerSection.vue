...
import type {
  ...
  AdminRetrospectiveProjectOption,
  BlogPostAdminDraft,
...
type Props = {
  ...
  categoryOptions: AdminBlogCategoryOption[]
  retrospectiveProjectOptions?: AdminRetrospectiveProjectOption[]
  seedDraft: BlogPostAdminDraft
  seedKey: string
}
...
const props = withDefaults(defineProps<Props>(), {
  ...
  editQueryId: null,
  isEditTargetPostLoading: false,
  editTargetPostErrorMessage: null,
...
<template>
  ...
  >
    ...
    <BlogPostAdminPanel
      ...
      :seed-draft="props.seedDraft"
      :seed-key="props.seedKey"
